# Agent setup for `blog`

This is a deepsec scanning workspace. Project `blog` was just registered
(target: `..`). Setup is incomplete — `data/blog/INFO.md`
...
2. **Fill in `data/blog/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id blog
pnpm deepsec process --project-id blog
```
