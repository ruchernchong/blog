...
export const ERROR_IDS = {
  ...
  OAUTH_CLIENT_FETCH_FAILED: "OAUTH_CLIENT_FETCH_FAILED",
  OAUTH_CLIENT_UPDATE_FAILED: "OAUTH_CLIENT_UPDATE_FAILED",
  OAUTH_CLIENT_DELETE_FAILED: "OAUTH_CLIENT_DELETE_FAILED",
